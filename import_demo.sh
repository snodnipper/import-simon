...
echo WWW Server: adding data
cp -R www_server_template www_server
mv www ./www_server

echo WWW Server: adding z2
mv -f z2_temp/* ./www_server/www/data/z2/
rm -Rf z2_temp

echo WWW Server: adding z12
mv -f z12_temp/* ./www_server/www/data/z12/
rm -Rf z12_temp

echo WWW Server: adding z15
mv -f z15_temp/* ./www_server/www/data/z15/
rm -Rf z15_temp

cd www_server
echo WWW Server: starting
docker-compose up
